...
namespace Negru_Luminita_Lab2.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList; 
        public void PopulateAssignedCategoryData(Negru_Luminita_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Negru_Luminita_Lab2Context context, 
